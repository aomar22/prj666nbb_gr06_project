        ...
        <PageCard className="mt-4 p-4">
            <section className="mt-4">
                <div className="flex items-center justify-between border-b-2 border-black/30 pb-3">
                    ...
                    <button className="px-4 py-2 rounded-lg bg-[#D97B7B] text-white font-semibold shadow">
                        Cancel
                    </button>
                    <button className="px-4 py-2 rounded-lg bg-[#7C8DB5] text-white font-semibold shadow">
                        Reschedule
                    </button>
                    </div>
