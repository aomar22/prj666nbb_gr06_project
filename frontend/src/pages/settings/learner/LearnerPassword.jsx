        ...
        <main className="flex-1 overflow-y-auto bg-[#F5F5F5]">
          ...
          <div className="grid min-h-[calc(100vh-89px)] grid-cols-[250px_minmax(0,1fr)]">
            ...
            <div className="border-r border-[#D6DEE8] bg-[#FAFAFA]">
              <button
                type="button"
                onClick={() => navigate("/settings/learner/profile/edit")}
            ...
            <div className="bg-[#F5F5F5] px-[54px] pt-[28px] pb-[28px]">
              ...
              {/* Password card */}
              <div className="mt-[28px] min-h-[371px] w-full max-w-[980px] rounded-[8px] border border-[#CFCFCF] bg-[#F7F7F7] px-6 pt-4 pb-5 shadow-[0px_1px_4px_rgba(0,0,0,0.14)]">
                <h3 className="text-[23px] font-bold text-black">Password Information</h3>
                ...
                <div className="mt-6">
                  ...
                  {confirmPassword && newPassword !== confirmPassword && (
                    <p className="mt-2 text-[14px] text-red-600 font-medium">
              ...
              <div className="mt-[28px] flex justify-end gap-5 max-w-[980px]">
                ...
                <button
                  ...
                  className={`h-[50px] w-[120px] rounded-[15px] text-[20px] font-bold text-white shadow-[0px_3px_6px_rgba(0,0,0,0.2)] ${
                    isUpdateDisabled || isUpdating ? "bg-[#8CBFEF] cursor-not-allowed" : "bg-[#118BFF]"
                  }`}
                >
